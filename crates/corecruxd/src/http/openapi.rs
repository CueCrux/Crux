...
const ROUTES: &[RouteEntry] = &[
    ...
    RouteEntry { path: "/v1/memory/candidates", methods: &["GET"], tag: "Memory", auth: "read", summary: "Auto-capture candidate review queue" },
    RouteEntry { path: "/v1/memory/candidates/{id}/promote", methods: &["POST"], tag: "Memory", auth: "write", summary: "Promote a candidate to a real fact" },
    RouteEntry { path: "/v1/memory/candidates/{id}/reject", methods: &["POST"], tag: "Memory", auth: "write", summary: "Reject a candidate" },
    ...
    RouteEntry { path: "/v1/incidents", methods: &["GET", "POST"], tag: "Incidents", auth: "feature-gated", summary: "Incident reconstruction cases" },
    RouteEntry { path: "/v1/incidents/{id}", methods: &["GET"], tag: "Incidents", auth: "feature-gated", summary: "Incident reconstruction case" },
    RouteEntry { path: "/v1/incidents/{id}/export", methods: &["POST"], tag: "Incidents", auth: "feature-gated", summary: "Export a certified incident evidence pack" },
    ...
    RouteEntry { path: "/v1/memory/native", methods: &["GET"], tag: "Memory", auth: "read", summary: "List the harness-native memory store (read-only projection)" },
    RouteEntry { path: "/v1/memory/native/search", methods: &["GET"], tag: "Memory", auth: "read", summary: "Search native memory descriptions" },
    RouteEntry { path: "/v1/memory/native/{slug}", methods: &["GET"], tag: "Memory", auth: "read", summary: "Fetch one native memory with its body" },
    ...
    RouteEntry { path: "/v1/provenance/sign", methods: &["POST"], tag: "Provenance", auth: "feature-gated", summary: "Provenance sign (BYOK)" },
    RouteEntry { path: "/v1/provenance/verify", methods: &["POST"], tag: "Provenance", auth: "feature-gated", summary: "Provenance verify (stateless)" },
    RouteEntry { path: "/v1/provenance/verify-record", methods: &["POST"], tag: "Provenance", auth: "feature-gated", summary: "Provenance verify + signed record" },
